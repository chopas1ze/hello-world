	...
	/*	System.out.println("1부터 100까지 숫자를 입력하세요:");
		for (int i = 1; i < 100; i++) {
			...
			if (userNum < randomNum) {
				System.out.println("1부터 100사이의 값 중 입력한 값보다 큰 값을 입력하세요.");
				System.out.println("1부터 100까지 숫자를 입력하세요:");
				

			} else if (userNum > randomNum) {
				System.out.println("1부터 100사이의 값 중 입력한 값보다 작은 값을 입력하세요.");
				System.out.println("1부터 100까지 숫자를 입력하세요:");


			} else if (userNum == randomNum) {
				System.out.println("사용자가 입력한 값과 컴퓨터가 발생시킨 임의의 값이 일치합니다.");
				System.out.println("총 실행횟수는 " + count + "번입니다");
				break;
			}
		}*/
