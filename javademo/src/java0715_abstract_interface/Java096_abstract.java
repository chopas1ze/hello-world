...
/*
 * 클래스 : 일반클래스, 추상클래스, 인터페이스
 *    
 * 메소드 정의 : 메소드 선언부 + 메소드 구현부
 * void prn(){}  // 소괄호까지가 메소드 선언부  , 대괄호는 메소드 구현부
 * 
 * 추상메소드 : 구현부가 없는 메소드이다.
 *  abstract void prn();
 *  
 *  추상클래스 : 추상메소드를 가지고 있는 클래스이다.  추상메소드가 하나라도 있는 클래스 .  
 *   abstract class Test{ }
 *   
...
class SendaAbs extends CarAbs { // 에러 클래스명 클릭후 오버라이딩 선택가능. 또는 wo + 컨트롤 + 스페이스 or
								// 컨트롤 + 스페이스
