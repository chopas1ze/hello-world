 ...
 *  3 외부클래스의 private으로 선언된 멤버변수를 직접적으로 접근해서
 *    처리할 수 있다.
 *    
 *  내부클래스 종류
 *  1  인스턴스 클래스 : 외부클래스의 멤버변수 선언위치에 선언하며, 
 *     외부 클래스의 인스턴스멤버처럼 다루어진다. 주로 외부 클래스의 
 *     인스턴스멤버들과 관련된 작업에 사용될 목적으로 선언된다.
 *              
 *  2 스태틱 클래스 : 외부 클래스의 멤버변수 선언위치에 선언하며,
