...
class Exercise11_20 {
	...
	static int displayMenu() {
		...
		/*
		 * (1) 알맞은 코드를 넣어 완성하시오. 1. 화면으로부터 메뉴를 입력받는다. 메뉴의 값은 1~3사이의 값이어야 한다. 2.
		 * 1~3사이의 값을 입력받지 않으면, 메뉴의 선택이 잘못되었음을 알려주고 다시 입력받는다.(유효한 값을 입력받을 때까지
		 * 반복해서 입력받는다.)
		 */
	...
	static void inputRecord() {
		...
		while (true) {
			...
			/*
			 * (2) 알맞은 코드를 넣어 완성하시오. 1. Scanner를 이용해서 화면으로 부터 데이터를 입력받는다.(','를
			 * 구분자로) 2. 입력받은 값이 q 또는 Q이면 메서드를 종료하고, 그렇지 않으면 입력받은 값으로
