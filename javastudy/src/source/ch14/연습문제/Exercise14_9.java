...
class Exercise14_9 extends Frame {
	...
	void fileOpen(String fileName) {
		/*
		 * (1) 알맞은 코드를 넣어 완성하시오. 1. BuffredReader와 FileReader를 이용해서 지정된 파일을
	...
	void saveAs(String fileName) {
		/*
		 * (2) 알맞은 코드를 넣어 완성하시오. 1. BuffredWriter와 FileWriter를 생성한다. 2. content에
		 * 있는 내용을 가져와서 BufferedWriter에 출력한다. 3. BufferedWriter를 닫는다.
		 */
	} // saveAs메서드의 끝
